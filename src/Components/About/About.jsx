...
const About = () => {
  let language =  <div className='flex justify-center tablet:justify-center gap-8 mt-9 w-full flex-col phone:flex-row items-center phone:items-start'>
   ...
   <>
     <article className='w-[80%] phone:w-[70%]  h-96 relative top-28 phone:top-52 gap-10 phone:gap-0  left-1/2 -translate-x-1/2 mb-20 grid grid-cols-1 tablet:grid-cols-2' >
      <section className='w-full  space-y-4 pl-4'>
        <h1 className='text-[25px] phone:text-[45px] font-bold text-white'>About <span className='text-red-700'>Me</span>.</h1>
        <p className='text-white text-sm'>Passionate about web development, I am a junior developer specializing in creating responsive and modern user interfaces. I am proficient in React and Tailwind CSS to design smooth and elegant user experiences. My expertise also includes working with SQL and PHP to develop robust and dynamic web applications. Currently, I am getting familiar with Next.js to enhance my full-stack development skills and deliver even more efficient solutions</p>
      </section>
