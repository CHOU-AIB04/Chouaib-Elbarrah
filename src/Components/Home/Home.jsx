    ...
    <>
        <section className='w-[80%] h-96 relative  top-20 phone:top-52 left-1/2 phone:left-0 -translate-x-1/2 phone:translate-x-0 flex justify-center'>
            <div className='flex flex-col gap-9 items-center phone:items-start p-0 phone:pl-7'>
                ...
                <p className='font-bold w-[90%] phone:w-[650px] text-[14px] text-white'>Veritatis sint illo, dolor ducimus saepe tempora cumque quas itaque totam et, fugit iste dignissimos eaque. Ad eligendi nisi harum? Eligendi, eos. suscipit eaque aperiam sed harum vel praesentium ad! Deserunt rem hic, provident maxime ex omnis.</p>
